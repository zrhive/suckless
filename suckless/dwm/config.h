...
/***** AUDIO AND BACKLIGHT ****/
static const char *volup[]    = { "fn-audio-up", NULL };
static const char *voldown[]  = { "fn-audio-down", NULL };
static const char *volmute[]  = { "fn-audio-mute", NULL };
...
static const Key keys[] = {
  ...
  { MODKEY|METAKEY,                 XK_0,         setlayout,            {0} },
  { MODKEY|METAKEY,                 XK_minus,     togglefloating,       {0} },
  { MODKEY|METAKEY|ShiftMask,       XK_minus,     unfloatvisible,       {0} },
  ...
  { MODKEY|METAKEY|ShiftMask,       XK_9,         unfloatvisible,       {.v = &layouts[8]} },
	{ MODKEY|METAKEY,                 XK_backslash, togglefullscreen,     {0} },
	{ MODKEY|METAKEY|ShiftMask,       XK_backslash, togglefakefullscreen, {0} },
  /******* MONITOR *****************************************************/
